...
function getSampleTerms() {
  return [
    { ru: 'Операционная система', kz: 'Операциялық жүйе' },
    { ru: 'Оперативная память', kz: 'Жедел жад' },
    { ru: 'Жесткий диск', kz: 'Қатты диск' },
    { ru: 'Исходный код', kz: 'Бастапқы код' },
    { ru: 'Программирование', kz: 'Бағдарламалау' },
    { ru: 'Переменная', kz: 'Айнымалы' },
    { ru: 'Функция', kz: 'Функция' }, 
    { ru: 'Условие', kz: 'Шарт' },
    { ru: 'Отладка', kz: 'Жөндеу' },
    { ru: 'Сеть', kz: 'Желі' },
    { ru: 'IP-адрес', kz: 'IP-мекенжай' },
    { ru: 'Шифрование', kz: 'Шифрлау' },
    { ru: 'Кибербезопасность', kz: 'Киберқауіпсіздік' },
    { ru: 'База данных', kz: 'Деректер қоры' },
    { ru: 'Таблица', kz: 'Кесте' },
    { ru: 'Запрос', kz: 'Сұраныс' },
    { ru: 'Резервное копирование', kz: 'Сақтық көшірме' },
    { ru: 'Облачные вычисления', kz: 'Бұлттық есептеу' }
  ];
}
